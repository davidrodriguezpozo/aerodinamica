function [p_gradX, p_gradY] = gradient_p(datos, p, nodal_mesh)
...
for i=1:Vy
    for j=1:Vx
        P_matrix(i,j) = p(nodal_mesh(i,j)); % P_matrix =  [Vx,Vy]
    end
end
...
%     end
    ...
    p_gradX(i,j) = (p_e - p_p)/Delta_x;
    p_gradY(i,j) = (p_n - p_p)/Delta_y;
